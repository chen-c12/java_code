	...
	<script type="text/javascript">
		$(function () {
			...
			$("button.addToCart").click(function () {
				...
				// 	location.href = "http://localhost:8080/WebTmp/cartServlet?action=addItem&id=" + bookId;
				// }

				$.getJSON("http://localhost:8080/WebTmp/cartServlet","action=ajaxAddItem&id="+bookId,function (data) {
		...
		<div id="book">
			...
			<div style="text-align: center">
				<c:if test="${empty sessionScope.lastName}">
					...
					<div>
						<span style="color: red" id="cartLastName">快添加商品到购物车吧！</span>
					</div>
				</c:if>
